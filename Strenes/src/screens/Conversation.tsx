...
export function Conversation() {
  ...
  return (
    <>
      {showProfile && <ContactProfileModal contactId={contact.id} onClose={() => setShowProfile(false)} />}
      {/* Header */}
      <div className="glass-h px-3 pb-3 flex items-center gap-3" style={{ paddingTop: 'calc(12px + env(safe-area-inset-top, 0px))' }}>
        ...
        <div onClick={() => setShowProfile(true)} className="cursor-pointer"><Avatar name={contact.name} grad={contact.grad} size={36} trusted={contact.trusted} /></div>
