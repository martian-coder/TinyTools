...
export const THEMES: Record<ThemeName, ThemeMeta> = {
  ...
  daylight: {
    label: 'Daylight',
    swatch: 'linear-gradient(135deg,#5b5fcb,#0891b2)',
    isLight: true,
    vars: {
      '--base': '#e9ecf9',
  ...
  honey: {
    label: 'Honey',
    swatch: 'linear-gradient(135deg,#CA8A04,#FACC15)',
    isLight: true,
    vars: {
      '--base': '#FFFFFF',
      '--g1': 'rgba(202,138,4,.16)',
      '--g2': 'rgba(250,204,21,.18)',
      '--g3': 'rgba(254,240,138,.16)',
      '--accent': '#CA8A04',
      '--accent2': '#FACC15',
      '--text': '#1C1C1E',
      '--dim': 'rgba(28,28,30,.6)',
      ...
      '--in': 'rgba(255,255,255,.95)',
    },
  },
  midnightGold: {
    label: 'Midnight Gold',
    swatch: 'linear-gradient(135deg,#10B981,#F5C518)',
    isLight: false,
    vars: {
      '--base': '#0A0F0C',
      '--g1': 'rgba(16,185,129,.4)',
      '--g2': 'rgba(245,197,24,.3)',
      '--g3': 'rgba(5,150,105,.32)',
      '--accent': '#10B981',
      '--accent2': '#F5C518',
      '--text': '#F4F1E8',
      '--dim': 'rgba(244,241,232,.55)',
  ...
  ios: {
    label: 'iOS',
    swatch: 'linear-gradient(135deg,#007AFF,#34C759)',
    isLight: true,
    vars: {
      '--base': '#F2F2F7',
      '--g1': 'rgba(0,122,255,.16)',
      '--g2': 'rgba(52,199,89,.12)',
      '--g3': 'rgba(175,82,222,.10)',
      '--accent': '#007AFF',
      '--accent2': '#34C759',
      '--text': '#1C1C1E',
      '--dim': 'rgba(60,60,67,.6)',
