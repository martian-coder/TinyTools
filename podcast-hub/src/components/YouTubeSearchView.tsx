          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-300 font-normal mt-0.5">
                Accurate YouTube video search, direct profile sync, instant AI brainstorming, and business blueprinting.
              </p>
            </div>
          </div>

          {/* YouTube Profile & API Settings Button */}
            ...
            {connectedProfile ? (
              <div className="flex items-center gap-2 bg-slate-800/80 border border-slate-700/80 pl-2 pr-3 py-1.5 rounded-2xl">
                ...
                <button
                  ...
                  className="ml-1 text-slate-400 hover:text-red-400 transition-colors p-1 shrink-0"
                >
