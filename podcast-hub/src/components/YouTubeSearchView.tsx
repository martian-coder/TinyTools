...
export const YouTubeSearchView: React.FC<YouTubeSearchViewProps> = ({
  ...
  return (
    <div className="space-y-4">
      {/* Modern Compact YouTube Studio Header Toolbar */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 pb-2 border-b border-[#272727]">
        {/* Topic Pills */}
        ...
        <div className="flex items-center gap-2 shrink-0 self-end md:self-auto">
          {onCreateKnowledgeGroup && (
            <button
              ...
              className="px-3.5 py-1.5 rounded-full bg-[#3ea6ff] hover:bg-[#2697ff] text-black text-xs font-bold flex items-center gap-1.5 transition-all shadow-md cursor-pointer shrink-0"
            >
          ...
          {!connectedProfile ? (
            <button
              ...
              className="px-3.5 py-1.5 rounded-full bg-[#272727] hover:bg-[#3f3f3f] border border-[#3f3f3f] text-[#f1f1f1] text-xs font-semibold flex items-center gap-1.5 transition-all cursor-pointer shrink-0"
            >
              <Tv className="w-3.5 h-3.5 text-[#3ea6ff]" />
              <span>Connect Channel</span>
            </button>
          ) : (
            <div className="flex items-center gap-2 bg-[#212121] border border-[#272727] pl-2 pr-3 py-1 rounded-full">
              <img src={connectedProfile.avatar} alt="Profile" className="w-5 h-5 rounded-full object-cover border border-[#3ea6ff] shrink-0" />
