    ...
    _renderAnthropicMode() {
        return html`
            ...
            <div class="form-group">
                ...
                <select
                    .value=${this._anthropicModel}
                    @change=${e => this._saveAnthropicModel(e.target.value)}
                >
                    <option value="claude-opus-4-8" ?selected=${this._anthropicModel === 'claude-opus-4-8'}>Claude Opus 4.8 (most capable)</option>
                    <option value="claude-sonnet-4-6" ?selected=${this._anthropicModel === 'claude-sonnet-4-6'}>Claude Sonnet 4.6 (recommended)</option>
                    <option value="claude-haiku-4-5" ?selected=${this._anthropicModel === 'claude-haiku-4-5'}>Claude Haiku 4.5 (fastest)</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                ></textarea>
                <div class="form-hint">Becomes the cached system prompt — update before each meeting</div>
            </div>
